...
movies_dict = pickle.load(open('D:/Python/ML/MovieRecomSystem/movies_dict.pkl', 'rb'))
movies = pd.DataFrame(movies_dict)
similarity = pickle.load(open('D:/Python/ML/MovieRecomSystem/similarity.pkl', 'rb'))
